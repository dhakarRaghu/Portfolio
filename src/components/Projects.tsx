...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "AI-powered learning platform offering personalized course generation.",
      longDescription:
    ...
    <section id="projects" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      className="group/btn flex items-center justify-center space-x-2 px-6 py-3 bg-secondary/20 hover:bg-secondary/30 text-secondary rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-secondary/25 active:scale-95 border border-secondary/30 hover:border-secondary/50"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group/btn flex items-center justify-center space-x-2 px-6 py-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-primary/25 active:scale-95"
                    >
            ...
            >
              ...
              <div className="p-6">
                <h4 className="text-lg font-semibold mb-2 group-hover:text-primary transition-colors duration-300">
                  {project.title.includes("|") ? project.title.split("|")[0] : project.title}
                </h4>
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  {project.tags.slice(0, 3).map((tag) => (
                    <span key={tag} className="px-2 py-1 bg-secondary/20 text-secondary text-xs rounded-md">
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex space-x-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group/btn flex-1 flex items-center justify-center space-x-2 py-2.5 px-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-md hover:shadow-primary/20 active:scale-95 text-sm"
                  >
        ...
        <div className="text-center mt-20">
          <div className="max-w-2xl mx-auto p-8 bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 border border-primary/20 rounded-xl">
            <h3 className="text-2xl font-semibold text-foreground mb-4">Want to see more of my work?</h3>
            <p className="text-muted-foreground mb-6">
              Explore my complete portfolio on GitHub and discover more innovative projects and contributions.
            </p>
            <a
              href="https://github.com/dhakarRaghu"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center space-x-2 px-6 py-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg transition-all duration-300 hover:scale-105"
            >
